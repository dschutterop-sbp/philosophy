...
const conformanceSchema = { type: "object", additionalProperties: false, required: ["conforms", "violations", "checks", "advisoryFit"], properties: { conforms: { type: "boolean" }, violations: { type: "array", items: { type: "string" } }, checks: { type: "array", items: { type: "object", additionalProperties: false, required: ["boundary", "passed"], properties: { boundary: { type: "string" }, passed: { type: "boolean" } } } }, advisoryFit: { type: "boolean" } } };
